...
@app.route("/retrieve_itinerary_details", methods=['POST'])
def retrieve_itinerary_details():
    ...
    if request.is_json:
        try:
            ...
            result = processRetrieveItineraryDetails(itineraryid)
...
def processRetrieveItineraryDetails(itineraryid):
